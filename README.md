...
- WebSocket public streams for Binance, Bybit, OKX, Bitget, Kraken, MEXC, BitMart, and BitMEX, with authenticated user-data streams for Binance, Bybit, OKX, Bitget, Kraken, MEXC, BitMart, and BitMEX
