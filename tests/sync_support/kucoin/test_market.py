...
def test_get_spot_all_tickers(client):
    res = client.get_spot_all_tickers()
    assert res is not None


@pytest.mark.private
def test_get_spot_orderbook(client):
    res = client.get_spot_orderbook(product_symbol="BTC-USDT-SPOT")
    assert res is not None
...
def test_get_spot_kline(client):
    res = client.get_spot_kline(product_symbol="BTC-USDT-SPOT", timeframe="1m")
    assert res is not None


def test_get_futures_contracts(client):
    res = client.get_futures_contracts()
    assert res is not None


def test_get_futures_contract(client):
    res = client.get_futures_contract(product_symbol="BTC-USDT-SWAP")
    assert res is not None
...
def test_get_futures_orderbook(client):
    res = client.get_futures_orderbook(product_symbol="BTC-USDT-SWAP")
    assert res is not None


def test_get_futures_part_orderbook(client):
    res = client.get_futures_orderbook(product_symbol="BTC-USDT-SWAP", depth=20)
    assert res is not None


def test_get_futures_public_trades(client):
    res = client.get_futures_public_trades(product_symbol="BTC-USDT-SWAP")
    assert res is not None


def test_get_futures_kline(client):
    res = client.get_futures_kline(product_symbol="BTC-USDT-SWAP", timeframe="1m")
    assert res is not None
