...
CURRENT_FIELDS = {
    ...
    "get_uta_instruments": {"category", "product_symbol", "symbol"},
    "get_uta_kline": {"category", "product_symbol", "interval", "type_"},
    "get_reality_stock_info": {"product_symbol", "symbol"},
    "place_reality_order": {"category", "product_symbol", "orderType", "qty"},
    "cancel_reality_order": {"category", "product_symbol", "orderId", "clientOid"},
