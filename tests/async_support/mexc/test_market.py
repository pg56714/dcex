...
@pytest.mark.asyncio
async def test_stock_linked_product_metadata(client):
    spot = await client.get_spot_exchange_info(symbols="AAPLONUSDT,AAPLXUSDT")
    ...
    contracts = await client.get_contract_details()
