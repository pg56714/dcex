        ...
        |case| {
            ...
            async move {
                request_case!(
                    ...
                    case,
                    [
                        get_contract_deals => get_contract_deals_with,
                        get_contract_depth => get_contract_depth_with,
                        get_contract_depth_commits => get_contract_depth_commits_with,
                        get_contract_details => get_contract_details_with,
                        get_contract_fair_price => get_contract_fair_price_with,
                        get_contract_fair_price_kline => get_contract_fair_price_kline_with,
                        get_contract_funding_rate => get_contract_funding_rate_with,
                        get_contract_funding_rate_history => get_contract_funding_rate_history_with,
                        get_contract_index_price => get_contract_index_price_with,
                        get_contract_index_price_kline => get_contract_index_price_kline_with,
                        get_contract_kline => get_contract_kline_with,
                        get_contract_risk_reverse => get_contract_risk_reverse_with,
                        get_contract_risk_reverse_history => get_contract_risk_reverse_history_with,
                        get_contract_ticker => get_contract_ticker_with,
                        get_contract_time => get_contract_time_with,
                        get_spot_agg_trades => get_spot_agg_trades_with,
                        get_spot_avg_price => get_spot_avg_price_with,
                        ...
                        get_spot_klines => get_spot_klines_with,
        ...
        |case| {
            ...
            async move {
                request_case!(
                    ...
                    case,
                    [
                        get_contract_asset => get_contract_asset_with,
                        ...
                        get_contract_leverage => get_contract_leverage_with,
                        get_contract_open_orders => get_contract_open_orders_with,
                        ...
                        get_contract_risk_limits => get_contract_risk_limits_with,
                        get_contract_stop_orders => get_contract_stop_orders_with,
                        get_contract_trading_fee_rate => get_contract_trading_fee_rate_with,
                        ...
                        get_spot_all_orders => get_spot_all_orders_with,
                        ...
                        get_user_universal_transfer_history => get_user_universal_transfer_history_with,
