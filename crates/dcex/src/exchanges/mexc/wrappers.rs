...
crate::exchanges::impl_exchange_method_wrappers! {
    ...
    private [
        ...
        place_contract_plan_order(product_symbol => "product_symbol", vol => "vol", side => "side", open_type => "openType", trigger_price => "triggerPrice", trigger_type => "triggerType", execute_cycle => "executeCycle", order_type => "orderType", trend => "trend"),
