...
pub(super) const TRADE_EASY_CONVERT_CURRENCIES: &str = "/api/v5/trade/easy-convert-currency-list";
pub(super) const TRADE_EASY_CONVERT: &str = "/api/v5/trade/easy-convert";
pub(super) const TRADE_EASY_CONVERT_HISTORY: &str = "/api/v5/trade/easy-convert-history";
