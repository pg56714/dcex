...
pub(super) const SPOT_SYSTEM_STATUS: &str = "/0/public/SystemStatus";
pub(super) const SPOT_ASSETS: &str = "/0/public/Assets";
pub(super) const SPOT_SPREAD: &str = "/0/public/Spread";
...
pub(super) const EARN_STRATEGIES: &str = "/0/private/Earn/Strategies";
pub(super) const EARN_ALLOCATIONS: &str = "/0/private/Earn/Allocations";
pub(super) const EARN_ALLOCATE: &str = "/0/private/Earn/Allocate";
pub(super) const EARN_DEALLOCATE: &str = "/0/private/Earn/Deallocate";
pub(super) const EARN_ALLOCATE_STATUS: &str = "/0/private/Earn/AllocateStatus";
pub(super) const EARN_DEALLOCATE_STATUS: &str = "/0/private/Earn/DeallocateStatus";
...
pub(super) const SPOT_WEBSOCKET_TOKEN: &str = "/0/private/GetWebSocketsToken";
