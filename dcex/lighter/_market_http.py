"""Lighter public market-data HTTP client backed by Rust."""
...
class MarketHTTP(HTTPManager):
    ...
    def get_info(self) -> dict[str, Any] | list[Any]:
        ...
        return self._native_public("get_info", self._native_params(**locals()))

    def get_status(self) -> dict[str, Any] | list[Any]:
        """Retrieve Lighter API service status."""
        return self._native_public("get_status", self._native_params(**locals()))

    def get_announcement(self) -> dict[str, Any] | list[Any]:
        """Retrieve Lighter announcements."""
        return self._native_public("get_announcement", self._native_params(**locals()))
    ...
    def get_order_book_details(
        ...
        return self._native_public("get_order_book_details", self._native_params(**locals()))
    ...
    def get_order_books(
        ...
        return self._native_public("get_order_books", self._native_params(**locals()))
    ...
    def get_order_book_orders(
        ...
        return self._native_public("get_order_book_orders", self._native_params(**locals()))
    ...
    def get_recent_trades(
        ...
        return self._native_public("get_recent_trades", self._native_params(**locals()))
    ...
    def get_trades(
        ...
        return self._native_public("get_trades", self._native_params(**locals()))
    ...
    def get_candles(
        ...
        return self._native_public("get_candles", self._native_params(**locals()))

    def get_funding_rates(self) -> dict[str, Any] | list[Any]:
        """Retrieve Lighter funding rates."""
        return self._native_public("get_funding_rates", self._native_params(**locals()))
    ...
    def get_mark_price_candles(
        ...
        return self._native_public("get_mark_price_candles", self._native_params(**locals()))

    def get_market_price_charts(
        self, market_ids: list[int] | None = None
    ) -> dict[str, Any] | list[Any]:
        """Retrieve hourly price charts for the last 24 hours."""
        return self._native_public("get_market_price_charts", self._native_params(**locals()))

    def get_synthetic_spot_info(self, symbol: str) -> dict[str, Any] | list[Any]:
        """Retrieve synthetic spot information for an equity symbol."""
        return self._native_public("get_synthetic_spot_info", self._native_params(**locals()))
    ...
    def get_fundings(
        ...
        return self._native_public("get_fundings", self._native_params(**locals()))

    def get_exchange_stats(self) -> dict[str, Any] | list[Any]:
        """Retrieve Lighter exchange statistics."""
        return self._native_public("get_exchange_stats", self._native_params(**locals()))

    def get_execute_stats(self, period: str) -> dict[str, Any] | list[Any]:
        """Retrieve Lighter execution statistics."""
        return self._native_public("get_execute_stats", self._native_params(**locals()))
    ...
    def get_exchange_metrics(
        ...
        return self._native_public("get_exchange_metrics", self._native_params(**locals()))

    def get_deposit_networks(self) -> dict[str, Any] | list[Any]:
        """Retrieve supported Lighter deposit networks."""
        return self._native_public("get_deposit_networks", self._native_params(**locals()))

    def get_fastbridge_info(self) -> dict[str, Any] | list[Any]:
        """Retrieve Lighter fast bridge information."""
        return self._native_public("get_fastbridge_info", self._native_params(**locals()))

    def get_layer1_basic_info(self) -> dict[str, Any] | list[Any]:
        """Retrieve Lighter layer-1 basic information."""
        return self._native_public("get_layer1_basic_info", self._native_params(**locals()))
    ...
    def get_account(
        ...
        return self._native_public("get_account", self._native_params(**locals()))
    ...
    def get_accounts_by_l1_address(
        ...
        return self._native_public("get_accounts_by_l1_address", self._native_params(**locals()))
    ...
    def get_account_metadata(
        ...
        return self._native_public("get_account_metadata", self._native_params(**locals()))
    ...
    def get_api_keys(
        ...
        return self._native_public("get_api_keys", self._native_params(**locals()))
    ...
    def get_public_pools_metadata(
        ...
        return self._native_public("get_public_pools_metadata", self._native_params(**locals()))
    ...
    def get_pnl(
        ...
        return self._native_public("get_pnl", self._native_params(**locals()))

    def get_asset_details(self, asset_id: int | None = None) -> dict[str, Any] | list[Any]:
        """Retrieve Lighter asset metadata."""
        return self._native_public("get_asset_details", self._native_params(**locals()))

    def get_system_config(self) -> dict[str, Any] | list[Any]:
        """Retrieve Lighter system configuration."""
        return self._native_public("get_system_config", self._native_params(**locals()))
    ...
    def get_tokens(
        ...
        return self._native_public("get_tokens", self._native_params(**locals()))

    def get_token_list(self) -> dict[str, Any] | list[Any]:
        """Retrieve Lighter token list."""
        return self._native_public("get_token_list", self._native_params(**locals()))
