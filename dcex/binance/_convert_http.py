...
class ConvertHTTP(AccountHTTP, MarketHTTP):
    ...
    def get_convert_asset_info(self) -> list[dict[str, Any]]:
        """Call the Binance Convert private endpoint."""
        return self._native_private("get_convert_asset_info", self._params())
    ...
    def accept_convert_quote(self, quoteId: str) -> dict[str, Any]:
        """Call the Binance Convert private endpoint."""
        return self._native_private("accept_convert_quote", self._params(quoteId=quoteId))
    ...
    def cancel_convert_limit_order(self, orderId: int) -> dict[str, Any]:
        """Call the Binance Convert private endpoint."""
        return self._native_private("cancel_convert_limit_order", self._params(orderId=orderId))

    def get_open_convert_limit_orders(self) -> dict[str, Any]:
        """Call the Binance Convert private endpoint."""
        return self._native_private("get_open_convert_limit_orders", self._params())
