...
class AccountHTTP(HTTPManager):
    ...
    def get_futures_account(self, ccy: str = "usdt") -> dict[str, Any]:
        return self._native_private(
            "get_futures_account",
    ...
    def get_delivery_account(self, ccy: str = "usdt") -> dict[str, Any]:
        return self._native_private(
    ...
    def get_spot_account(self, ccy: str | None = None) -> dict[str, Any]:
        return self._native_private(
            "get_spot_account",
            self._native_params(ccy=ccy),
        )
    ...
    def get_spot_fee(self, product_symbol: str | None = None) -> dict[str, Any]:
        return self._native_private(
            "get_spot_fee",
