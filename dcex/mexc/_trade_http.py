"""MEXC private trading HTTP client."""
...
class TradeHTTP(HTTPManager):
    ...
    def test_spot_order(
        ...
        return self._request("POST", SpotTrade.TEST_ORDER, payload)
    ...
    def place_spot_order(
        ...
        return self._request("POST", SpotTrade.ORDER, payload)
    ...
    def cancel_contract_orders(
        ...
        return self._request("POST", ContractTrade.CANCEL_ORDERS, order_ids, api="contract")

    def cancel_contract_order(self, order_id: str | int) -> dict[str, Any] | list[Any]:
        """Cancel a MEXC Contract order by order id."""
        return self.cancel_contract_orders([order_id])
    ...
    def cancel_all_contract_orders(self, product_symbol: str) -> dict[str, Any] | list[Any]:
