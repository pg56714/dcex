"""MEXC public market-data HTTP client."""
...
class MarketHTTP(HTTPManager):
    ...
    def get_spot_default_symbols(self) -> dict[str, Any] | list[Any]:
        ...
        return self._request("GET", SpotMarket.DEFAULT_SYMBOLS, signed=False)
    ...
    def get_contract_time(self) -> dict[str, Any] | list[Any]:
        ...
        return self._request("GET", ContractMarket.PING, signed=False, api="contract")
    ...
    def get_contract_depth(
        ...
        return self._request("GET", path, {"limit": limit}, signed=False, api="contract")
    ...
    def get_contract_depth_commits(
        ...
        return self._request("GET", path, signed=False, api="contract")
    ...
    def get_contract_risk_reverse(self) -> dict[str, Any] | list[Any]:
        ...
        return self._request("GET", ContractMarket.RISK_REVERSE, signed=False, api="contract")
