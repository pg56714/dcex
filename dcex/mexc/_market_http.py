...
class MarketHTTP(HTTPManager):
    ...
    def get_spot_ticker_24hr(
        ...
        symbol = self._spot_symbol(product_symbol) if product_symbol is not None else None
        return self._native_public("get_spot_ticker_24hr", self._params(symbol=symbol))
    ...
    def get_spot_ticker_price(
        ...
        symbol = self._spot_symbol(product_symbol) if product_symbol is not None else None
        return self._native_public("get_spot_ticker_price", self._params(symbol=symbol))
    ...
    def get_spot_book_ticker(
        ...
        symbol = self._spot_symbol(product_symbol) if product_symbol is not None else None
        return self._native_public("get_spot_book_ticker", self._params(symbol=symbol))
    ...
    def get_contract_details(
        ...
        return self._native_public("get_contract_details", self._params(symbol=symbol))
    ...
    def get_contract_ticker(
        ...
        symbol = self._contract_symbol(product_symbol) if product_symbol is not None else None
        return self._native_public("get_contract_ticker", self._params(symbol=symbol))
