...
class TradeHTTP(HTTPManager):
    """Gate.io async trade HTTP client backed by Rust private dispatch."""
    ...
    async def get_delivery_all_positions(self, ccy: str = "usdt") -> dict[str, Any]:
        return await self._native_private(
    ...
    async def place_spot_market_buy_order(self, product_symbol: str, amount: str) -> dict[str, Any]:
        return await self._native_private(
