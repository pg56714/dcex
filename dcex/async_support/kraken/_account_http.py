...
class AccountHTTP(HTTPManager):
    ...
    async def get_spot_account_balance(
        ...
        return await self._request("POST", SpotAccount.BALANCE, query=payload, signed=True)
    ...
    async def get_spot_trade_balance(
        ...
        return await self._request("POST", SpotAccount.TRADE_BALANCE, query=payload, signed=True)
    ...
    async def get_spot_ledgers(
        ...
        return await self._request("POST", SpotAccount.LEDGERS, query=payload, signed=True)
    ...
    async def get_spot_trade_volume(
        ...
        return await self._request("POST", SpotAccount.TRADE_VOLUME, query=payload, signed=True)
