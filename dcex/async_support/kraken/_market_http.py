"""Kraken public market-data async HTTP client."""
...
class MarketHTTP(HTTPManager):
    ...
    async def get_spot_asset_pairs(
        ...
        return await self._request("GET", SpotMarket.ASSET_PAIRS, query=payload, signed=False)
    ...
    async def get_spot_ticker(
        ...
        return await self._request("GET", SpotMarket.TICKER, query=payload, signed=False)
    ...
    async def get_spot_orderbook(
        ...
        return await self._request("GET", SpotMarket.ORDERBOOK, query=payload, signed=False)
    ...
    async def get_spot_public_trades(
        ...
        return await self._request("GET", SpotMarket.PUBLIC_TRADES, query=payload, signed=False)
    ...
    async def get_spot_kline(
        ...
        return await self._request("GET", SpotMarket.OHLC, query=payload, signed=False)
