"""Async Bybit RFQ HTTP client backed by Rust."""
...
class RFQHTTP(HTTPManager):
    """Async HTTP client for Bybit Request for Quote workflows."""
    ...
    async def get_rfq_config(self) -> dict[str, Any]:
        ...
        return await self._native_private("get_rfq_config", [])
    ...
    async def cancel_all_rfqs(self) -> dict[str, Any]:
        """Cancel every active RFQ."""
        return await self._native_private("cancel_all_rfqs", [])

    async def accept_other_rfq_quote(self, rfqId: str) -> dict[str, Any]:
        """Allow a non-LP quote for an RFQ."""
        return await self._native_private(
            "accept_other_rfq_quote", self._native_params(rfqId=rfqId)
        )
    ...
    async def cancel_all_rfq_quotes(self) -> dict[str, Any]:
        """Cancel every active quote."""
        return await self._native_private("cancel_all_rfq_quotes", [])

    async def get_realtime_rfqs(
        self,
        *,
        rfqId: str | None = None,
        rfqLinkId: str | None = None,
    ...
    async def get_realtime_rfq_quotes(
        self,
        *,
        rfqId: str | None = None,
        quoteId: str | None = None,
    ...
    async def get_rfq_trade_history(
        self,
        *,
        rfqId: str | None = None,
        rfqLinkId: str | None = None,
