"""Aster V3 public market-data async HTTP client."""
...
class MarketHTTP(HTTPManager):
    ...
    async def ping_futures(self) -> dict[str, Any] | list[Any]:
        ...
        return await self._request("GET", FuturesMarket.PING, signed=False)
    ...
    async def get_futures_server_time(self) -> dict[str, Any] | list[Any]:
        ...
        return await self._request("GET", FuturesMarket.SERVER_TIME, signed=False)
    ...
    async def get_futures_exchange_info(self) -> dict[str, Any] | list[Any]:
        ...
        return await self._request("GET", FuturesMarket.EXCHANGE_INFO, signed=False)
    ...
    async def get_futures_ticker_24hr(
        ...
        symbol = self._symbol(product_symbol) if product_symbol else None
        return await self._request(
            "GET", FuturesMarket.TICKER_24HR, {"symbol": symbol}, signed=False
        )
    ...
    async def get_futures_ticker_price(
        ...
        symbol = self._symbol(product_symbol) if product_symbol else None
        return await self._request(
            "GET", FuturesMarket.TICKER_PRICE, {"symbol": symbol}, signed=False
        )
    ...
    async def get_futures_book_ticker(
        ...
        symbol = self._symbol(product_symbol) if product_symbol else None
        return await self._request(
            "GET", FuturesMarket.BOOK_TICKER, {"symbol": symbol}, signed=False
        )
    ...
    async def get_futures_premium_index(
        ...
        symbol = self._symbol(product_symbol) if product_symbol else None
        return await self._request(
            "GET", FuturesMarket.PREMIUM_INDEX, {"symbol": symbol}, signed=False
        )
    ...
    async def get_futures_funding_info(
        ...
        symbol = self._symbol(product_symbol) if product_symbol else None
        return await self._request(
            "GET", FuturesMarket.FUNDING_INFO, {"symbol": symbol}, signed=False
        )
