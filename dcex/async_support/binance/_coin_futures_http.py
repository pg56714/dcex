...
class CoinFuturesHTTP(AccountHTTP, MarketHTTP):
    ...
    async def get_coin_futures_exchange_info(self) -> dict[str, Any]:
        """Call the Binance COIN-M public endpoint."""
        return await self._native_public("get_coin_futures_exchange_info", self._params())

    async def get_coin_futures_orderbook(
    ...
    async def get_coin_futures_trades(
        self, symbol: str, limit: int | None = None
    ) -> list[dict[str, Any]]:
        """Call the Binance COIN-M public endpoint."""
        return await self._native_public(
    ...
    async def get_coin_futures_klines(
        self,
        symbol: str,
        interval: str,
    ...
    async def get_coin_futures_ticker(
    ...
    async def get_coin_futures_mark_price(
        self, symbol: str | None = None, pair: str | None = None
    ) -> dict[str, Any] | list[dict[str, Any]]:
        """Call the Binance COIN-M public endpoint."""
        return await self._native_public(
    ...
    async def get_coin_futures_funding_rate(
        self,
        symbol: str,
        startTime: int | None = None,
        endTime: int | None = None,
    ...
    async def get_coin_futures_balance(self) -> list[dict[str, Any]]:
        """Call the Binance COIN-M private endpoint."""
        return await self._native_private("get_coin_futures_balance", self._params())

    async def get_coin_futures_account(self) -> dict[str, Any]:
        """Call the Binance COIN-M private endpoint."""
        return await self._native_private("get_coin_futures_account", self._params())

    async def get_coin_futures_positions(
    ...
    async def get_coin_futures_open_orders(
        self, symbol: str | None = None, pair: str | None = None
    ) -> list[dict[str, Any]]:
        """Call the Binance COIN-M private endpoint."""
        return await self._native_private(
    ...
    async def get_coin_futures_order(
    ...
    async def place_coin_futures_order(
        self,
        symbol: str,
        side: str,
        order_type: str,
    ...
    async def cancel_coin_futures_order(
        self, symbol: str, orderId: int | None = None, origClientOrderId: str | None = None
    ) -> dict[str, Any]:
        """Call the Binance COIN-M private endpoint."""
        return await self._native_private(
    ...
    async def cancel_all_coin_futures_orders(self, symbol: str) -> dict[str, Any]:
        """Call the Binance COIN-M private endpoint."""
        return await self._native_private(
            "cancel_all_coin_futures_orders", self._params(symbol=symbol)
        )
