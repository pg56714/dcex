...
class AccountHTTP(HTTPManager):
    ...
    async def get_all_margin_assets(self) -> list[dict[str, Any]]:
        """Return assets supported by Binance Margin."""
        return cast(
            list[dict[str, Any]],
            await self._native_private("get_all_margin_assets", []),
        )

    async def get_all_cross_margin_pairs(self) -> list[dict[str, Any]]:
        """Return all cross-margin trading pairs."""
        return cast(
            list[dict[str, Any]],
            await self._native_private("get_all_cross_margin_pairs", []),
        )

    async def get_all_isolated_margin_symbols(self) -> list[dict[str, Any]]:
        """Return all isolated-margin symbols."""
        return cast(
            list[dict[str, Any]],
            await self._native_private("get_all_isolated_margin_symbols", []),
        )

    async def get_margin_price_index(self, product_symbol: str) -> dict[str, Any]:
    ...
    async def get_cross_margin_account(self, recvWindow: int | None = None) -> dict[str, Any]:
    ...
    async def borrow_margin_asset(
        ...
        *,
        ...
        return await self.margin_borrow_repay(
            asset,
            amount,
            "BORROW",
            isIsolated=isIsolated,
    ...
    async def get_margin_borrow_repay_records(
        self,
        type_: str,
        *,
        asset: str | None = None,
    ...
    async def get_simple_earn_account(self, recvWindow: int | None = None) -> dict[str, Any]:
    ...
    async def get_flexible_earn_products(
        self,
        *,
        asset: str | None = None,
        current: int | None = None,
    ...
    async def get_locked_earn_products(
        self,
        *,
        asset: str | None = None,
        current: int | None = None,
    ...
    async def get_flexible_earn_positions(
        self,
        *,
        asset: str | None = None,
    ...
    async def get_locked_earn_positions(
        self,
        *,
        asset: str | None = None,
    ...
    async def subscribe_flexible_earn(
        self,
        productId: str,
        amount: str,
        *,
    ...
    async def subscribe_locked_earn(
        self,
        projectId: str,
        amount: str,
        *,
    ...
    async def redeem_flexible_earn(
        self,
        productId: str,
        *,
    ...
    async def get_flexible_earn_subscription_history(
        self,
        *,
        productId: str | None = None,
    ...
    async def get_locked_earn_subscription_history(
        self,
        *,
        purchaseId: str | None = None,
        asset: str | None = None,
    ...
    async def get_flexible_earn_redemption_history(
        self,
        *,
        productId: str | None = None,
    ...
    async def get_locked_earn_redemption_history(
        self,
        *,
        positionId: str | None = None,
        redeemId: str | None = None,
    ...
    async def get_flexible_earn_rewards_history(
        self,
        *,
        productId: str | None = None,
        asset: str | None = None,
        ...
        return await self._native_private("get_flexible_earn_rewards_history", params)

    async def get_locked_earn_rewards_history(
        self,
        *,
        positionId: str | None = None,
        asset: str | None = None,
    ...
    async def check_flexible_loan_collateral_repay_rate(
        self,
        loanCoin: str,
        collateralCoin: str,
        recvWindow: int | None = None,
    ...
    async def adjust_flexible_loan_ltv(
        self,
        loanCoin: str,
        collateralCoin: str,
    ...
    async def get_flexible_loan_assets(
        self,
    ...
    async def get_flexible_loan_collateral_assets(
        self,
    ...
    async def get_flexible_loan_interest_rate_history(
        self,
        coin: str,
        *,
        startTime: int | None = None,
    ...
    async def _get_flexible_loan_history(
        self,
        method_name: str,
        *,
        loanCoin: str | None = None,
    ...
    async def get_flexible_loan_borrow_history(
        self,
        *,
        loanCoin: str | None = None,
        collateralCoin: str | None = None,
        ...
        return await self._get_flexible_loan_history(
    ...
    async def get_flexible_loan_repayment_history(
        self,
        *,
        loanCoin: str | None = None,
        collateralCoin: str | None = None,
    ...
    async def get_flexible_loan_ltv_adjustment_history(
        self,
        *,
        loanCoin: str | None = None,
        collateralCoin: str | None = None,
    ...
    async def get_flexible_loan_liquidation_history(
        self,
        *,
        loanCoin: str | None = None,
        collateralCoin: str | None = None,
    ...
    async def get_crypto_loan_income_history(
        self,
        *,
        asset: str | None = None,
        type_: str | None = None,
        ...
        params = self._params(**{key: value for key, value in locals().items() if key != "self"})
        params = [("type" if key == "type_" else key, value) for key, value in params]
        return await self._native_private("get_crypto_loan_income_history", params)

    async def _get_stable_loan_history(
        self,
        method_name: str,
        *,
    ...
    async def get_stable_loan_borrow_history(
        self,
        *,
        orderId: int | None = None,
        loanCoin: str | None = None,
        ...
        return await self._get_stable_loan_history(
    ...
    async def get_stable_loan_repayment_history(
        self,
        *,
        orderId: int | None = None,
        loanCoin: str | None = None,
    ...
    async def get_stable_loan_ltv_adjustment_history(
        self,
        *,
        orderId: int | None = None,
        loanCoin: str | None = None,
    ...
    async def _staking_query(self, method_name: str, **params: object) -> dict[str, Any]:
        return await self._native_private(method_name, self._params(**params))

    async def get_eth_staking_account(self, recvWindow: int | None = None) -> dict[str, Any]:
        """Return ETH staking balances and recent earnings."""
        return await self._staking_query("get_eth_staking_account", recvWindow=recvWindow)

    async def get_eth_staking_quota(self, recvWindow: int | None = None) -> dict[str, Any]:
        """Return ETH staking and redemption quota details."""
        return await self._staking_query("get_eth_staking_quota", recvWindow=recvWindow)

    async def get_eth_redemption_history(self, **params: object) -> dict[str, Any]:
        """Return ETH staking redemption history."""
        return await self._staking_query("get_eth_redemption_history", **params)

    async def get_eth_staking_history(self, **params: object) -> dict[str, Any]:
        """Return ETH staking subscription history."""
        return await self._staking_query("get_eth_staking_history", **params)

    async def get_wbeth_rate_history(self, **params: object) -> dict[str, Any]:
        """Return WBETH conversion-rate history."""
        return await self._staking_query("get_wbeth_rate_history", **params)

    async def get_wbeth_rewards_history(self, **params: object) -> dict[str, Any]:
        """Return WBETH reward history."""
        return await self._staking_query("get_wbeth_rewards_history", **params)

    async def get_wbeth_unwrap_history(self, **params: object) -> dict[str, Any]:
        """Return WBETH unwrap history."""
        return await self._staking_query("get_wbeth_unwrap_history", **params)

    async def get_wbeth_wrap_history(self, **params: object) -> dict[str, Any]:
        """Return WBETH wrap history."""
        return await self._staking_query("get_wbeth_wrap_history", **params)

    async def subscribe_eth_staking(
        self, amount: str, recvWindow: int | None = None
    ) -> dict[str, Any]:
        """Stake ETH and receive WBETH."""
        return await self._staking_query(
            "subscribe_eth_staking", amount=amount, recvWindow=recvWindow
        )

    async def redeem_eth_staking(
        self,
        amount: str,
        *,
        asset: str | None = None,
    ...
    async def wrap_beth(self, amount: str, recvWindow: int | None = None) -> dict[str, Any]:
        """Wrap BETH into WBETH."""
        return await self._staking_query("wrap_beth", amount=amount, recvWindow=recvWindow)

    async def get_onchain_yields_personal_quota(
    ...
    async def get_onchain_yields_products(self, **params: object) -> dict[str, Any]:
        """Return available locked On-chain Yields products."""
        return await self._staking_query("get_onchain_yields_products", **params)

    async def get_onchain_yields_positions(self, **params: object) -> dict[str, Any]:
        """Return locked On-chain Yields positions."""
        return await self._staking_query("get_onchain_yields_positions", **params)

    async def get_onchain_yields_redemption_history(self, **params: object) -> dict[str, Any]:
        """Return On-chain Yields redemption history."""
        return await self._staking_query("get_onchain_yields_redemption_history", **params)

    async def get_onchain_yields_rewards_history(self, **params: object) -> dict[str, Any]:
        """Return On-chain Yields reward history."""
        return await self._staking_query("get_onchain_yields_rewards_history", **params)

    async def preview_onchain_yields_subscription(
        self,
        projectId: str,
        amount: str,
        *,
    ...
    async def get_onchain_yields_subscription_history(self, **params: object) -> dict[str, Any]:
        """Return On-chain Yields subscription history."""
        return await self._staking_query("get_onchain_yields_subscription_history", **params)

    async def get_onchain_yields_account(self, recvWindow: int | None = None) -> dict[str, Any]:
        """Return the On-chain Yields account summary."""
        return await self._staking_query("get_onchain_yields_account", recvWindow=recvWindow)

    async def subscribe_onchain_yields(
        self,
        projectId: str,
        amount: str,
        *,
    ...
    async def redeem_onchain_yields(
        self,
        positionId: str,
        *,
        channelId: str | None = None,
    ...
    async def set_onchain_yields_auto_subscribe(
        self,
        positionId: str,
        autoSubscribe: bool,
        recvWindow: int | None = None,
    ...
    async def set_onchain_yields_redeem_option(
        self,
        positionId: str,
        redeemTo: str,
        recvWindow: int | None = None,
    ...
    async def get_soft_staking_products(self, **params: object) -> dict[str, Any]:
        """Return available Soft Staking products."""
        return await self._staking_query("get_soft_staking_products", **params)

    async def get_soft_staking_rewards_history(self, **params: object) -> dict[str, Any]:
        """Return Soft Staking reward history."""
        return await self._staking_query("get_soft_staking_rewards_history", **params)

    async def set_soft_staking(
        self, softStaking: bool, recvWindow: int | None = None
    ) -> dict[str, Any]:
    ...
    async def get_sol_staking_account(self, recvWindow: int | None = None) -> dict[str, Any]:
        """Return SOL staking balances and earnings."""
        return await self._staking_query("get_sol_staking_account", recvWindow=recvWindow)

    async def get_sol_staking_quota(self, recvWindow: int | None = None) -> dict[str, Any]:
        """Return SOL staking quota details."""
        return await self._staking_query("get_sol_staking_quota", recvWindow=recvWindow)

    async def get_bnsol_rate_history(self, **params: object) -> dict[str, Any]:
        """Return BNSOL conversion-rate history."""
        return await self._staking_query("get_bnsol_rate_history", **params)

    async def get_bnsol_rewards_history(self, **params: object) -> dict[str, Any]:
        """Return BNSOL reward history."""
        return await self._staking_query("get_bnsol_rewards_history", **params)

    async def get_sol_boost_rewards_history(self, **params: object) -> dict[str, Any]:
        """Return SOL staking Boost reward history."""
        return await self._staking_query("get_sol_boost_rewards_history", **params)

    async def get_sol_redemption_history(self, **params: object) -> dict[str, Any]:
        """Return SOL staking redemption history."""
        return await self._staking_query("get_sol_redemption_history", **params)

    async def get_sol_staking_history(self, **params: object) -> dict[str, Any]:
        """Return SOL staking subscription history."""
        return await self._staking_query("get_sol_staking_history", **params)

    async def get_sol_unclaimed_rewards(self, recvWindow: int | None = None) -> dict[str, Any]:
        """Return unclaimed SOL Boost rewards."""
        return await self._staking_query("get_sol_unclaimed_rewards", recvWindow=recvWindow)

    async def claim_sol_boost_rewards(self, recvWindow: int | None = None) -> dict[str, Any]:
        """Claim SOL Boost rewards."""
        return await self._staking_query("claim_sol_boost_rewards", recvWindow=recvWindow)

    async def subscribe_sol_staking(
        self, amount: str, recvWindow: int | None = None
    ) -> dict[str, Any]:
        """Stake SOL and receive BNSOL."""
        return await self._staking_query(
            "subscribe_sol_staking", amount=amount, recvWindow=recvWindow
        )

    async def redeem_sol_staking(
        self, amount: str, recvWindow: int | None = None
    ) -> dict[str, Any]:
        """Redeem BNSOL for SOL."""
        return await self._staking_query("redeem_sol_staking", amount=amount, recvWindow=recvWindow)

    async def _subaccount_query(self, method_name: str, **params: object) -> dict[str, Any]:
        return await self._native_private(method_name, self._params(**params))
    ...
    async def get_subaccounts(
        ...
        *,
        ...
        return await self._subaccount_query(
            "get_subaccounts",
            email=email,
            isFreeze=isFreeze,
            page=page,
    ...
    async def get_subaccount_status(
        ...
        return await self._subaccount_query(
            "get_subaccount_status", email=email, recvWindow=recvWindow
        )

    async def get_subaccount_transaction_statistics(
    ...
    async def get_subaccount_futures_position_risk(
        self,
        email: str,
        futuresType: int = 1,
        recvWindow: int | None = None,
    ...
    async def get_subaccount_futures_account(
        self,
        email: str,
        futuresType: int = 1,
        recvWindow: int | None = None,
    ...
    async def get_subaccount_margin_account(
        self, email: str, recvWindow: int | None = None
    ) -> dict[str, Any]:
    ...
    async def get_subaccount_futures_summary(
        self,
        futuresType: int = 1,
        *,
        page: int | None = None,
    ...
    async def get_subaccount_margin_summary(self, recvWindow: int | None = None) -> dict[str, Any]:
        """Return the master account's sub-account margin summary."""
        return await self._subaccount_query("get_subaccount_margin_summary", recvWindow=recvWindow)
    ...
    async def get_subaccount_assets(
        ...
        return await self._subaccount_query(
            "get_subaccount_assets", email=email, recvWindow=recvWindow
        )

    async def get_subaccount_spot_summary(
        self,
        *,
        email: str | None = None,
        page: int | None = None,
    ...
    async def transfer_subaccount_futures(
        self,
        email: str,
        asset: str,
        amount: str,
    ...
    async def transfer_subaccount_margin(
        self,
        email: str,
        asset: str,
        amount: str,
    ...
    async def get_subaccount_futures_transfer_history(
        self,
        email: str,
        futuresType: int = 1,
        **params: object,
    ...
    async def transfer_between_subaccount_futures(
        self,
        fromEmail: str,
        toEmail: str,
        futuresType: int,
    ...
    async def get_subaccount_spot_transfer_history(self, **params: object) -> dict[str, Any]:
        """Return spot transfers between accounts under the same master."""
        return await self._subaccount_query("get_subaccount_spot_transfer_history", **params)

    async def get_subaccount_universal_transfer_history(self, **params: object) -> dict[str, Any]:
        """Return universal transfers between accounts under the same master."""
        return await self._subaccount_query("get_subaccount_universal_transfer_history", **params)
    ...
    async def get_subaccount_transfer_history(self, **params: object) -> dict[str, Any]:
        """Return transfer history when authenticated as a sub-account."""
        return await self._subaccount_query("get_subaccount_transfer_history", **params)

    async def transfer_subaccount_to_master(
    ...
    async def transfer_subaccount_to_subaccount(
        self,
        toEmail: str,
        asset: str,
        amount: str,
