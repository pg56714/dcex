...
class TradeHTTP(HTTPManager):
    ...
    def get_rfqs(
        ...
        """Retrieve active RFQs, optionally filtered by product or RFQ ID."""
    ...
    def refresh_rfq(self, rfq_id: str) -> dict[str, Any] | list[Any] | str:
        """Refresh an RFQ."""
        return self._native_private("refresh_rfq", self._native_params(rfqId=rfq_id))
