"""Extended trade HTTP client backed by Rust."""
...
class TradeHTTP(HTTPManager):
    """HTTP client for Extended order endpoints."""
    ...
    def get_order(self, id: int | str) -> Any:  # noqa: A002, ANN401
        return self._native_private("get_order", self._native_params(id=id))

    def get_order_by_external_id(self, externalId: int | str) -> Any:  # noqa: N803, ANN401
        return self._request("GET", f"/api/v1/user/orders/external/{externalId}", signed=True)

    def get_orders_by_external_id(self, externalId: int | str) -> Any:  # noqa: N803, ANN401
    ...
    def place_order(
        ...
        *,
        ...
        if body is not None:
            return self._native_private("place_order", self._native_params(body=body))
    ...
    def cancel_order_by_external_id(self, externalId: str) -> Any:  # noqa: N803, ANN401
        return self._native_private(
            "cancel_order_by_external_id",
            self._native_params(externalId=externalId),
        )

    def mass_cancel(self, body: Mapping[str, Any]) -> Any:  # noqa: ANN401
        return self._native_private("mass_cancel", self._native_params(body=body))

    def set_deadmanswitch(self, countdownTime: int) -> Any:  # noqa: N803, ANN401
