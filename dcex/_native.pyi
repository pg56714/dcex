...
class BinanceEquityWebSocketClient:
    def __init__(
        self,
        stream: str,
        product_symbol: str | None = None,
...
class BybitPrivateWebSocketClient:
    ...
    async def send_trade_order(self, op: str, args_json: str) -> str: ...
...
class LighterCredentials:
    ...
    @staticmethod
    def from_env(network: str = "mainnet") -> LighterCredentials: ...
    @property
...
class LighterHttpClient(_NativeExchangeClient):
    ...
    @staticmethod
    def from_env(timeout: float = 10.0, network: str = "mainnet") -> LighterHttpClient: ...
...
class LighterPrivateWebSocketClient:
    ...
    @staticmethod
    def from_env(
        network: str = "mainnet", timeout: float = 10.0
    ) -> LighterPrivateWebSocketClient: ...
    def account_index(self) -> int: ...
    def create_auth_token(
        self, deadline: int | None = None, api_key_index: int | None = None
    ) -> str: ...
...
class OndoHttpClient(_NativeExchangeClient):
    def __init__(
        self,
...
class OndoPublicWebSocketClient:
    def __init__(self, timeout: float = 10.0, base_url: str | None = None) -> None: ...
    def is_connected(self) -> bool: ...
    async def connect(self) -> None: ...
    async def close(self) -> None: ...
    async def ping(self) -> None: ...
    async def subscribe(self, channel: str, markets: list[str] | None = None) -> None: ...
    async def unsubscribe(self, channel: str, markets: list[str] | None = None) -> None: ...
    async def subscribe_klines(self, market: str, resolution: str) -> None: ...
    async def recv(self) -> bytes: ...

class OndoPrivateWebSocketClient:
    def __init__(
        self,
        api_key_id: str | None = None,
        api_secret: str | None = None,
