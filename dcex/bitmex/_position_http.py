"""BitMEX private position HTTP client backed by Rust."""
...
class PositionHTTP(HTTPManager):
    """HTTP client for BitMEX position APIs."""
    ...
    def get_positions(
        ...
        return self._native_private("get_positions", params)
    ...
    def get_margining_mode(
        ...
        self._append_target_account_ids(params, target_account_ids)
        return self._native_private("get_margining_mode", params)
    ...
    def get_margin(
        ...
        self._append_target_account_ids(params, target_account_ids)
        return self._native_private("get_margin", params)
