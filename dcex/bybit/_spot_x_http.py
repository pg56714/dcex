"""Bybit Spot X Launchpool HTTP client backed by Rust."""
...
class SpotXHTTP(HTTPManager):
    ...
    def get_launchpool_current_staking(self) -> dict[str, Any]:
        """Get active Launchpool staking positions and portfolio totals."""
        return self._native_private("get_launchpool_current_staking", [])

    def get_launchpool_activity_log(
        self,
        *,
