...
class TradeHTTP(HTTPManager):
    ...
    def place_swap_batch_order(self, batchOrders: list) -> dict[str, Any]:
    ...
    def close_swap_position(self, positionId: str) -> dict[str, Any]:
        return self._native_private("close_swap_position", self._native_call_params(locals()))

    def close_swap_all_positions(self, product_symbol: str) -> dict[str, Any]:
