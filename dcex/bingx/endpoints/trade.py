...
class SpotTrade(str, Enum):
    """BingX spot trade API endpoints."""

    PLACE_ORDER = "/openApi/spot/v1/trade/order"
    PLACE_BATCH_ORDER = "/openApi/spot/v1/trade/batchOrders"
    CANCEL_ORDER = "/openApi/spot/v1/trade/cancel"
    CANCEL_BATCH_ORDERS = "/openApi/spot/v1/trade/cancelOrders"
    CANCEL_OPEN_ORDERS = "/openApi/spot/v1/trade/cancelOpenOrders"
    QUERY_ORDER = "/openApi/spot/v1/trade/query"
    QUERY_OPEN_ORDERS = "/openApi/spot/v1/trade/openOrders"
    QUERY_ORDER_HISTORY = "/openApi/spot/v1/trade/historyOrders"
    QUERY_MY_TRADES = "/openApi/spot/v1/trade/myTrades"
    COMMISSION_RATE = "/openApi/spot/v1/user/commissionRate"
