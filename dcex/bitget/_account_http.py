...
class AccountHTTP(HTTPManager):
    ...
    def get_uta_account_assets(self) -> dict[str, Any]:
        ...
        return self._request("GET", UtaAccount.ASSETS, signed=True)

    def get_uta_account_info(self) -> dict[str, Any]:
        """Retrieve Bitget UTA API account information."""
        return self._request("GET", UtaAccount.INFO, signed=True)
    ...
    def set_uta_leverage(
        ...
        return self._request("POST", UtaAccount.SET_LEVERAGE, payload, signed=True)

    def set_uta_hold_mode(self, holdMode: str) -> dict[str, Any]:
        """Set Bitget UTA holding mode."""
        return self._request("POST", UtaAccount.SET_HOLD_MODE, {"holdMode": holdMode}, signed=True)
