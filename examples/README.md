...
- `*_ws_private_readonly.py` files require credentials and only open user-data streams; they do not place or cancel orders.
- WebSocket examples currently cover public streams for Binance, BingX, Bybit, OKX, Bitget, BitMart, BitMEX, Gate.io, Kraken, KuCoin, and MEXC, plus private user-data streams for Binance, BingX, Bybit, OKX, Bitget, BitMart, BitMEX, Gate.io, Kraken, KuCoin, and MEXC.
