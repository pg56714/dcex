...
- `benchmark_core_local.py` measures local CPU-bound PyO3 wrapper calls and Rust native calls for the same Rust core operation. It prints Markdown by default and writes CSV only when `--csv` is provided.
