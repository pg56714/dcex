...
- `benchmark_core_local.py` measures local CPU-bound Python fallback, PyO3 bridge, and Rust native speedups. Speedups are relative to the Python fallback. It prints Markdown by default and writes CSV only when `--csv` is provided.
